<div class=" px-3 lg:px-7 py-6">
    ...
    <div wire:loading.attr='disabled' class="py-4 flex flex-col items-center">
        <svg wire:loading.delay aria-hidden="true"
            class="w-6 h-6 text-gray-200 animate-spin dark:text-gray-600 fill-red-600" viewBox="0 0 100 101"
